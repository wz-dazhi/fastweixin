...
public class CustomAPI extends BaseAPI {
	 ...
	 * @return 调用结果
	 */
	public ResultType sendCustomMessage(String openid, String[] customservices, BaseMsg message) {
		...
		// 传入客服kf_account,这个地方没有写好,因为没有获取所有的客服信息,没有判断是否存在该客服
		if (null != customservices && !"".equals(customservices)) {
			Map<String, String> customservice = new HashMap<String, String>();
			for (String custom : customservices) {
				customservice.put("kf_account", custom);
			}
